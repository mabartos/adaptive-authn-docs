...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{img/sections/5-design/ai-engine-remote-new.png}
...
For more details and specific requirements for the external integration, see the Chapter \ref{spec-external-integration}.
