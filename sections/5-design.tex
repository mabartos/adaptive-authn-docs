...
As seen in Figure \ref{fig:user-context-ip-address-context}, the \textit{IpAddressContext} abstract class extends the \textit{UserContext} abstract class and specifies that the retrieved data will be of type \textit{IPAddress}, which is a structure describing the IP address attributes.
